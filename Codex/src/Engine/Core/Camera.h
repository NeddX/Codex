...
namespace codex {
    ...
    public:
        inline void UpdateProjectionMatrix()
        {
            ...
            // m_Projection = glm::perspective(math::ToRadf(90.0f), (f32)(m_Width / m_Height), 0.1f, 100.0f);
        ...
        inline Matrix4f GetViewMatrix()
        {
            ...
            m_View = glm::lookAt(Vector3f(position.x, position.y, 20.0f),
                                 camera_front + Vector3f(position.x, position.y, 0.0f), camera_up);
            return m_View;
        }
