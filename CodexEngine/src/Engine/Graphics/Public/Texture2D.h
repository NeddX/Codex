...
namespace codex::gfx {
    ...
    using TextureWrapMode       = mgl::TextureWrapMode;
    using TextureFormat         = mgl::TextureFormat;
    using TextureFormatType     = mgl::TextureFormatType;
    using TextureMipmapMode     = mgl::TextureMipmapMode;
