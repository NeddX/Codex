...
namespace codex {
    ...
    constexpr auto LINE2D_VERTEX_SIZE =
        LINE2D_VERTEX_COUNT * LINE2D_VERTEX_COMPONENT_COUNT; // The total count of the elements in the buffer
    ...
    public:
        ...
        static void DrawLine2D(const Vector2f source, const Vector2f destination,
                               const Vector4f colour = { 1.0f, 1.0f, 1.0f, 1.0f }, const i32 lifeTime = 1);
        static void DrawRect2D(const Rectf rect, const f32 angle = 0.0f,
                               const Vector4f colour = { 1.0f, 1.0f, 1.0f, 1.0f }, const i32 lifeTime = 1);
        static void DrawCircle2D(const Vector2f centrePos, const i32 radius = 50, const i32 segments = 20,
                                 const Vector4f colour = { 1.0f, 1.0f, 1.0f, 1.0f }, i32 lifeTime = 1);
